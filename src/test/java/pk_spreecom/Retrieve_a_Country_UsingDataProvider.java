...
public class Retrieve_a_Country_UsingDataProvider extends Spreecom_TestData{

	@Test(dataProvider="country_iso")//dataProvider will call method and let us read data from method
